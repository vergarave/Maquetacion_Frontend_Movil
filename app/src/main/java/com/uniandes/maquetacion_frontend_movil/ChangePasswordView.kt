...
/** Rendering of the 390 x 844 "Cambiar Contraseña" Figma frame. */
class ChangePasswordView @JvmOverloads constructor(
    context: Context,
    ...
    private val fieldTops = floatArrayOf(280f, 380f, 480f)
    private val inputs = arrayOf(
        createPasswordInput("••••••••"),
        createPasswordInput("Mínimo 8 caracteres"),
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.withScale(designScale, designScale) {
            drawHeader(this)
            drawField(this, "Contraseña Actual", inputs[0], 280f)
            drawField(this, "Contraseña Nueva", inputs[1], 380f)
            drawField(this, "Confirmar contraseña nueva", inputs[2], 480f)
            drawSaveButton(this)
        }
    }
    ...
    private fun drawHeader(canvas: Canvas) {
        ...
        drawCenteredText(canvas, "Cambiar Contraseña", 195f, 80f, 24f, PRIMARY, bold)
    }
    ...
    private fun drawField(canvas: Canvas, label: String, input: EditText, top: Float) {
        ...
        val value = input.text.toString().let { text ->
            if (text.isEmpty()) input.hint.toString() else "•".repeat(text.length)
        }
    ...
    private fun createPasswordInput(hint: String): EditText = EditText(context).apply {
        background = null
        setPadding(0, 0, 0, 0)
        setSingleLine(true)
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) =
                this@ChangePasswordView.invalidate()
